...
The full architecture, every module, entity, invariant, precondition, event, and the reasoning behind each design decision, is documented in `docs/architecture_decisions/`, the design document this README summarizes. Nothing in this system was arrived at by convention; every decision has a recorded "why."
...
Full module by module detail, every stress test finding, and the reasoning behind each architectural decision live in `docs/architecture_decisions/`.
